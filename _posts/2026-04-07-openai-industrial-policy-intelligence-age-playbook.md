...
- `baseline`: low-cost, broadly available AI tools for all teams,
- `advanced`: high-capability tools for approved high-impact workflows,
- `frontier`: tightly governed access with extra audit and safety controls.
...
- `productivity`: cycle time, output per FTE, automation rate,
- `distribution`: training uptake, internal mobility, compensation alignment, access equity across teams.
